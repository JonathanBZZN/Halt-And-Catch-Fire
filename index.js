...
const story = 'a game called Wake Up.html';
...
const handlers = {
  ...
  'AMAZON.HelpIntent': function() {
    var speechOutput = 'If you are stuck ';
    var reprompt = 'you could just ask where you are or something like that';
    speechOutput = speechOutput + reprompt;
    var cardTitle = 'Help.';
    var cardContent = speechOutput;
    var imageObj = undefined;
  ...
  'CompletelyExit': function() {
    var speechOutput = 'Sweet Dreams My Summer Child. They Watch.';
    if (TableName) {
